...
$changepassword = "http://" . $_SERVER['HTTP_HOST'] . "/admin/chgpwd.php"; // Path to change password file
$login = "http://" . $_SERVER['HTTP_HOST'] . "/admin/login.php"; // Path to page with the login box
$logout = "http://" . $_SERVER['HTTP_HOST'] . "/admin/logout.php"; // Path to logout page

// DB SETTINGS
$dbhost = "mysql_host";	// Change this to the proper DB Host name
$dbusername = "mysql_user"; 	// Change this to the proper DB User
$dbpass = "mysql_password";	// Change this to the proper DB User password
$dbname	= "mysql_db_name"; 	// Change this to the proper DB Name
