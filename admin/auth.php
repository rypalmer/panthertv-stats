...
class auth{
	...
	var $HOST = "mysql_host";	// Change this to the proper DB HOST
	var $USERNAME = "mysql_user";	// Change this to the proper DB USERNAME
	var $PASSWORD = "mysql_password";	// Change this to the proper DB USER PASSWORD
	var $DBNAME = "mysql_db_name";	// Change this to the proper DB NAME
