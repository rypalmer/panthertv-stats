<?php
    ...
    if (($check['level'] < 101) || ($check['level'] > 150))
    {
...
include ("include.php");
include ("/home/.horlicks/upeiism/stats.upeiism.org/functions.php");
...
exit();
	...
	$game_type_current = $row3['game_type'];
...
<img border="0" src="http://stats.upeiism.org/render.php?size=20&display_home_team=<?=$team_editors;?>"></a></center>
...
if($game_type_current == 1 || $game_type_current == 2)
{
...
if($game_type_current == 3 || $game_type_current == 4)
{
$total_minutes = 91;
 ?>
	<select name="period">
	<option value="10"<?=$selected10;?>>Pre-game</option>
	<option value="11"<?=$selected11;?>>1st Half</option>
	<option value="12"<?=$selected12;?>>1st Half (injury time)</option>
	<option value="13"<?=$selected13;?>>Half time</option>
	<option value="14"<?=$selected14;?>>2nd Half</option>
	<option value="15"<?=$selected15;?>>2nd Half (injury time)</option>
	<option value="16"<?=$selected16;?>>Extra time</option>
	<option value="17"<?=$selected17;?>>Shoot-out</option>
	<option value="18"<?=$selected18;?>>Full time</option>
	</select>
...
<br />Assisting player 1 <select name="player_id_assist1"> 
...
<? echo $player_number, " ", $player_name, " assisted by ", $player_number_assist1, " and ", $player_number_assist2, $goal_type;
?></td></tr>
<? 
echo "\n"; 
