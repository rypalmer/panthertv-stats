...
imagettftext($im, $fsize2, 0, $pos2x, $pos2y, $colourblack, $arial, $score_home); 
imagettftext($im, $fsize3, 0, $pos3x, $pos3y, $colourblack, $arial, $score_away); 
imagettftext($im, $fsize4, 0, $pos4x, $pos4y, $colourtime, $arial, $periodheader); 
imagettftext($im, $fsize5, 0, $pos5x, $pos5y, $colourtime, $arial, $period); 
